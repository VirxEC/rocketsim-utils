...
pub const HITBOX_SIZES: [Vec3A; 6] = [
...
pub const HITBOX_OFFSETS: [Vec3A; 6] = [
...
pub const FRONT_WHEEL_RADS: [f32; 6] = [12.5, 12.0, 12.5, 13.5, 12.5, 15.0];
pub const BACK_WHEEL_RADS: [f32; 6] = [15.0, 13.5, 17.0, 15.0, 15.0, 15.0];

pub const FRONT_WHEEL_SUS_REST: [f32; 6] = [38.755, 33.95, 31.9242, 29.7, 38.755, 39.505];
pub const BACK_WHEEL_SUS_REST: [f32; 6] = [37.055, 33.85, 27.9242, 29.666, 37.055, 39.105];

pub const FRONT_WHEELS_OFFSET: [Vec3A; 6] = [
...
pub const BACK_WHEELS_OFFSET: [Vec3A; 6] = [
...
impl CarBodyConfig {
    const fn make_car_config(idx: usize) -> Self {
        Self {
    ...
    pub const OCTANE: Self = Self::make_car_config(0);
    pub const DOMINUS: Self = Self::make_car_config(1);
    pub const PLANK: Self = Self::make_car_config(2);
    pub const BREAKOUT: Self = Self::make_car_config(3);
    pub const HYBRID: Self = Self::make_car_config(4);
    pub const MERC: Self = Self::make_car_config(5);
}
